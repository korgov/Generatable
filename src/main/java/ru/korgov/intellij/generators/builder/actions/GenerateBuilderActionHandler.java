...
public class GenerateBuilderActionHandler extends GenerateConstructorHandler {
    ...
    protected MemberChooser<ClassMember> createMembersChooser(
        ...
        final MemberChooser<ClassMember> chooser = super.createMembersChooser(
                members,
                allowEmptySelection,
                copyJavadocCheckbox,
                project
    ...
    private void appendInnerBuilderIfNeed(
            final PsiClass clazz,
            final List<GenerationInfo> out,
...
//      System.out.println("compiled: " + classFromText.getText());
    ...
    private void appendConstructorIfNeed(
            final PsiClass aClass,
            final List<GenerationInfo> out,
            final PsiField[] fields
    ) {
